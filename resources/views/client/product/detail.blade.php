                ...
                <div class="col-lg-8 col-xl-9">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            ...
                            <form class="mb-5" action="/add-product-to-cart/{{ $product->id }}" method="POST">
                                @csrf
                                ...
                                <button type="submit" class="btn border border-secondary rounded-pill px-4 py-2 mt-4 text-primary">
